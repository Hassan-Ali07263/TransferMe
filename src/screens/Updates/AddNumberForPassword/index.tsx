...
const AddNumberForPassword = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.pleaseText}>Please add your mobile phone number to change your password</Text>
...
export default AddNumberForPassword;